...
{
    public partial class FrmEstudianteEliminar : Form
    {
        List<Object> lst_estudiantes_tmp;
        ClsEstudiante clsEstudiante = new ClsEstudiante();
        public FrmEstudianteEliminar(List<Object> lst_estudiantes_tmp)
        {
            InitializeComponent();
        ...
        {
            String cedula;
            cedula = dgvEstudiantes.CurrentRow.Cells[0].Value.ToString();
            MessageBox.Show(clsEstudiante.eliminarEstudiante(cedula));
            int pos = dgvEstudiantes.CurrentRow.Index;
            lst_estudiantes_tmp.RemoveAt(pos);
